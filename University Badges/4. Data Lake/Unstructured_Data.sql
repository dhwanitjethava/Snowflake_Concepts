...
-- Query the Unstructured External Data!
...
-- Challange : Nest 4 Functions into 1 Statement
select
...
-- Challange : Can you join the directory table and the new sweatsuits table?
...
select color_or_style, direct_url, price, size as image_size,
...
-- Convert Your Select Statement to a View - catalog
...
insert into UPSELL_MAPPING (SWEATSUIT_COLOR_OR_STYLE,UPSELL_PRODUCT_CODE)
values
...
select color_or_style,price,direct_url,size_list,
...
from
    ...
    from catalog
    group by color_or_style, price, direct_url, image_last_modified, image_size) c
...
-- SELECT on view CATALOG_FOR_WEBSITE
